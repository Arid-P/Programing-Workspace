 def into_ascii_chr(input_str: str, final_values: list[int]) -> None:
    """
    ...
    result_string = f'{input_str}{"".join(chars)}'
    print(f"\n{result_string}")
...
def main() -> None:
    ...
    final_values = process_string(input_str.lower())
    
    print(final_values)
    into_ascii_chr(input_str, final_values)
    return
...
#2. gamingra"BnC
#3 .programLr#rr=m
#4. competition9o"LeJBtEon
#5. personalLeHOo"7l
#6. Instagram: BnIiaCNa"

#7rELaJ;l"Lr#rr=m - Program
#7rE:a"7nF7tAE.INi7n' - Srijan

#7rELaJ;l"øa"BnC' - Gaming